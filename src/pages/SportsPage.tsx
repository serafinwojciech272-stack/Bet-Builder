  ...
  return <div className="space-y-8 rise">
    <section className="relative overflow-hidden rounded-2xl border border-market/20 bg-gradient-to-br from-market/[.10] via-surface to-surface-2 p-6 sm:p-8">
      ...
      <div className="relative flex flex-wrap items-end justify-between gap-5">
        <div><div className="flex flex-wrap items-center gap-2"><Chip tone="market"><Radio size={11}/> Źródło danych</Chip><Chip tone="positive"><span className="live-dot h-1.5 w-1.5 rounded-full bg-positive"/> Na żywo</Chip></div>
