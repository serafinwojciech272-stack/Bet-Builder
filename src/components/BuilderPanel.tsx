      ...
      {empty ? (
        ...
        <>
          ...
          <div className="space-y-3 border-t border-white/[.08] bg-black/10 p-4">
            ...
            <label className="block text-[9px] font-bold uppercase tracking-[.16em] text-slate-500">Stake<input type="number" min={0} value={stake} onChange={(e) => onUpdateStake(Number(e.target.value))} className="mt-1.5 w-full rounded-xl border border-white/10 bg-[#080c13] px-3 py-2.5 text-sm font-semibold text-white outline-none transition focus:border-violet-400/50" /></label>
