...
const rawEvents: RawProviderEvent[] = [
  ...
  {
    event_key: 'EVT-TEN-6001',
    sport: 'TENNIS',
    competition: 'ATP / WTA',
    country: 'International',
    home: { key: 'player-sinner', name: 'Jannik Sinner', abbr: 'SIN', power_index: 1880, recent_form: 'W,W,W,L,W', injuries_out: 0 },
    away: { key: 'player-alcaraz', name: 'Carlos Alcaraz', abbr: 'ALC', power_index: 1868, recent_form: 'W,W,L,W,W', injuries_out: 0 },
    commence_time: iso(155),
    state: 'SCHEDULED',
    venue: 'Centre Court',
    liquidity_index: 0.91,
    monitored: 1,
  },
  {
    event_key: 'EVT-VOL-7001',
    sport: 'VOLLEYBALL',
    competition: 'CEV Champions League',
    country: 'Europe',
    home: { key: 'team-zaksa', name: 'ZAKSA Kędzierzyn-Koźle', abbr: 'ZAK', power_index: 1710, recent_form: 'W,W,L,W,W', injuries_out: 0 },
    away: { key: 'team-trento', name: 'Trentino Volley', abbr: 'TRE', power_index: 1698, recent_form: 'W,L,W,W,L', injuries_out: 1 },
    commence_time: iso(275),
    state: 'SCHEDULED',
    venue: 'Hala Azoty',
    liquidity_index: 0.79,
    monitored: 1,
  ...
  {
    event_key: 'EVT-GOL-8001',
    sport: 'GOLF',
    competition: 'PGA Tournament',
    country: 'USA',
    home: { key: 'gol-scheffler', name: 'Scottie Scheffler', abbr: 'SCH', power_index: 1910, recent_form: 'W,W,D,W,W', injuries_out: 0 },
    away: { key: 'gol-mcilroy', name: 'Rory McIlroy', abbr: 'MCL', power_index: 1888, recent_form: 'W,L,W,W,D', injuries_out: 0 },
    commence_time: iso(610),
    state: 'SCHEDULED',
    venue: 'PGA Championship Course',
    liquidity_index: 0.68,
    monitored: 0,
  },
  {
...
const seriesSpecs: SeriesSpec[] = [
  ...
  {
    eventKey: 'EVT-TEN-6001',
    market: 'ML',
    books: ['OPENBOOK', 'BETFAIR', 'MERIDIAN'],
    selections: [
      { sel: 'home', name: 'Jannik Sinner', open: 1.72, drift: -0.08 },
      { sel: 'away', name: 'Carlos Alcaraz', open: 2.18, drift: 0.09 },
    ],
    points: 7,
    intervalMinutes: 18,
    lastCaptureMinutesAgo: 3,
  ...
  {
    eventKey: 'EVT-VOL-7001',
    market: 'ML',
    books: ['OPENBOOK', 'BETFAIR'],
    selections: [
      { sel: 'home', name: 'ZAKSA Kędzierzyn-Koźle', open: 1.78, drift: -0.05 },
      { sel: 'away', name: 'Trentino Volley', open: 2.02, drift: 0.06 },
    ],
    points: 6,
    intervalMinutes: 20,
    lastCaptureMinutesAgo: 5,
  ...
  {
    eventKey: 'EVT-GOL-8001',
    market: 'OUTRIGHTS',
    books: ['OPENBOOK', 'NORTHLINE'],
    selections: [
      { sel: 'home', name: 'Scottie Scheffler', open: 3.8, drift: -0.18 },
      { sel: 'away', name: 'Rory McIlroy', open: 5.2, drift: 0.12 },
    ],
    points: 5,
    intervalMinutes: 45,
    lastCaptureMinutesAgo: 9,
